...
class MenuItemsController < ApplicationController
  ...
  def destroy
    @menu_item.destroy
    respond_to do |format|
      format.html { redirect_to menu_items_url, notice: "MenuItem was successfully destroyed." }
  ...
  private
    ...
    def menu_item_params
      params.require(:menu_item).permit(:restaurant_id, :name, :description, :price, :photo)
    end
end
